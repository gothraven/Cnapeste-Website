        ...
        if ($query->have_posts()) :
          ...
          echo '<li><a href="'. get_permalink() .'">';
            if ( (function_exists( 'has_post_thumbnail' )) && ( has_post_thumbnail() ) ) :
              ...
              echo '<div class="flex-caption" dir="rtl">';
...
global $sparkling_footer_info;
  printf( esc_html__( 'Website by %1$s Powered by %2$s', 'sparkling' ) , '<a href="http://cnapestebatna.com/" target="_blank">Safiy Errahmane</a>', '<a href="http://cnapestebatna.com/" target="_blank">CNAPESTE</a>');
}
