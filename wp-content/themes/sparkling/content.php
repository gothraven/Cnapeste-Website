...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="blog-item-wrap" dir="rtl">
		...
		<div class="post-inner-content">
			...
			<div class="entry-content">
				...
				if ( get_theme_mod( 'sparkling_excerpts' ) == 1 ) :
					the_excerpt();?>
					<p><a class="btn btn-default read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'اقرأ أكثر', 'sparkling' ); ?></a></p>
				<?php else :
					the_content();
				endif;
				 ?>
